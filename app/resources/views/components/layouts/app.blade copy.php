...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="layout-fixed sidebar-expand-lg bg-body-tertiary sidebar-open app-loaded layout-footer-fixed">
    <!--begin::App Wrapper-->
    ...
    <script>
        ...
        function initializeOverlayScrollbars() {
            console.log('initializeOverlayScrollbars');

            let SELECTOR_SIDEBAR_WRAPPER = '.sidebar-wrapper';
            let Default = {
                scrollbarTheme: 'os-theme-light',
                scrollbarAutoHide: 'leave',
                scrollbarClickScroll: true,
            };
            let sidebarWrapper = document.querySelector(SELECTOR_SIDEBAR_WRAPPER);
            if (sidebarWrapper && typeof OverlayScrollbarsGlobal?.OverlayScrollbars !== 'undefined') {
                if (!OverlayScrollbarsGlobal.OverlayScrollbars(sidebarWrapper)) {
